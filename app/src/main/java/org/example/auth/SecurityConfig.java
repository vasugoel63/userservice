...
public class SecurityConfig {
    ...
    private final UserDetailServiceImp userDetailServiceImp; // injected automatically
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(userDetailServiceImp); // inject your service
        authProvider.setPasswordEncoder(passwordEncoder); // inject password encoder
        return authProvider;
    }
